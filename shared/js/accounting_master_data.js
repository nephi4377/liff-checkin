...
var AccountingMasterData = {
  ...
  /** 會計主檔包（廠商／LINE 綁定／列舉）— 3 天 TTL；逾 SWR_MS 背景重抓（SWR）
   *  2026-07-18／07-25：收款帳戶、費用分類、訂編案號對照已廢棄，bootstrap 固定空 */
  ...
  margin_vendor_slots: [
    ...
    { key: 'kitchen', label: '廚具設備', trade_categories: ['水電', '系統櫃'], cost_types: [] },
