...
const WRITE_ACTIONS = new Set(['createLog', 'updateLogText', 'updateLogPhotosWithUploads', 'deleteLog', 'updateProjectStatus', 'createFromTemplate', 'updateSchedule', 'sendNotification', 'createUploadJob', 'uploadJobDataChunk', 'process_notification_action', 'add_comment']);
