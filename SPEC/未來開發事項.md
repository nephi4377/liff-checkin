...
| **一半** | 我的案場（選材／簽約／兩層導覽） | 追加減＋收款已有；**未做**四卡片殼、簽約快照、選材（附錄） |
| **一半** | 個人假勤全覽（特休） | 有申請單＋當期試算；**未做**全年總覽、特休給額／剩餘（SPEC 17 §4.8） |
...
| **未完** | 靜態資源版本號不一致 | 怪行為時先強制重新整理 |
| **未完** | §13「一案綁定」修訂 | 規格書本體仍過時（附錄已註） |

### 已完成（已移出待辦，勿再排）

| 項 | 去向 |
|----|------|
| 主檔空白頁收斂（收款帳戶廢、費用分類不要、狀態走請款） | SPEC 15 v1.10、ACCOUNTING_MASTER_DATA_SPEC、DATA_MASTER_PLAN |
...
- **已做**：B5 追加減＋收款 LIFF；員工可預覽客戶頁。  
- **未做**：首屏四卡片、簽約快照、選材表、減項預設收合等（見下方附錄；已拍板未實作）。

### 3. 個人假勤全覽（含特休）｜一半

- **已做**：出勤／假勤申請／當期薪資核對試算。  
- **未做**：全年假勤總覽、特休已用／剩餘（[`17_個人薪資出勤頁計劃書.md`](17_個人薪資出勤頁計劃書.md) §4.8）。  
- **不做**：個人頁每次全表掃打卡＋排班。
...
*最後更新：2026-07-18 — 頂部項目總覽（未完／一半／已完成移出）；附錄選材規格仍保留供開工。*
