...
> **用途**：記錄已拍板方向、尚未實作的功能；**不是**當期 sprint。  
> **維護**：新項追加章節；開工後移入對應編號 SPEC（如 `21.案件毛利…`）並在本檔標「已移入 §X」。  
...
| 日期 | 摘要 |
|------|------|
| 2026-07-06 | **總監拍板（B）**：兩層導覽四卡片 IA、簽約快照凍結時點、減項預設收合、Phase A-1～A-3／B 步序、保留政策分流；§13「一案綁定」標過時（本檔為準，§13 待修訂） |

---

## 總監拍板決策（2026-07-06）

> **狀態**：已決策（協調者三代理共識；總監選 **B**）。細節見各 §；未列項目仍見「待總監確認」。
...
*最後更新：2026-07-06 — **總監拍板 B**：兩層導覽四卡片 IA、簽約快照凍結時點、保留政策分流、Phase A-1～A-3／B 步序；§13 一案綁定標過時（§13 待修訂）*
