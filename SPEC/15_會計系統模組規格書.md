...
### 2.1.2 LINE 單據快審 ✅ 主路徑已實作（2026-08-02｜行政以上）

- **入口**：會計選單「日常款項」→ **單據快審**（`quick_review.html`）；HUB `#/accounting/quick-review`
...
| `quick_review.html` | LINE 單據快審（五類；請款導待付款帶附件） | ≥ 2 | ✅ 主路徑 |

| `vendors.html` | 廠商主檔 + LINE 綁定（同一頁） | ≥ 3 | ✅ |
