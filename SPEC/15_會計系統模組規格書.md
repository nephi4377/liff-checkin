...
- 靜態頁 `ledger_review.html`：篩選待審／匯款狀態，核准、退回、標記已匯款；分攤列含 **含稅勾選**（與 `payment_request.html` 同規則，5% 稅、備註 `【稅別】`）
...
| `vendors.html` | 廠商主檔 + LINE 綁定 | ≥ 4 | ✅ |

| `payees.html` | 收款帳戶 CRUD | ≥ 4 | ✅ |

| `vendor_status.html` | 廠商款項進度（自服） | 廠商／在職員工 | ✅ |

| `ledger_review.html` | 收支審核／匯款狀態 | ≥ 4 | ✅ |
...
| `vendor_payment_approve.html` | 請款審核 | ≥ 5 | ✅ |

| `vendor_payment_finance.html` | 待匯款／產中信 TXT | ≥ 4 | ✅ |
