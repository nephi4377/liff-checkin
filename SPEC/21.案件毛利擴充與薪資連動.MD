...
**進入方式（2026-08-15）**：LINE 六格文案不變。收款確認那一鍵＝只開收款紀錄；我的案場那一鍵＝只開選材（網址帶選材標記）；綁定新專案那一鍵＝只開綁定。頁內不再放「收款／選材／綁定其他專案」功能卡，也不用頁內返回去切功能。客人選材清單對齊 Dropbox「選材」夾（尚未入列的檔也會列出）；定案日顯示年月日；照片優先用較穩的縮圖。
