...
**版本**：v1.0（2026-07-09）  
**關聯**：[01_系統架構深編規格書.md](01_系統架構深編規格書.md)、[07_全量系統全景圖.md](07_全量系統全景圖.md)、會計專圖：[會計系統架構圖.md](會計系統架構圖.md)
...
| 副本文字冒險 | 靜態站 `tools/story-adventure/`（正式：`/tools/story-adventure/`）；本機快取進行中 30 天／結束 3 天；HUB 卡片外連＋複製網址，非 iframe |
